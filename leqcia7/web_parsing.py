...
def move_to_detailed_page(receipt_url):
...
def get_urls(i):
    ...
    with ThreadPoolExecutor() as exc:
        f = [exc.submit(move_to_detailed_page, url) for url in receipt_urls]
...
with ThreadPoolExecutor() as executor:
    futures = [executor.submit(get_urls, i) for i in range(1, 5)]
